...
I use the last class day for testing and demonstrations.  I give each group the same company and data to evaluate and give them a fixed amount of time to use their assistants to attempt to generate a valuation, breaking out into groups.  Then, we reconvene, and each group shows the class how their tool performed, by scrolling through their chat history and explaining their process. 
