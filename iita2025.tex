...
\item Domain knowledge + AI + code $\Rightarrow$ superstar
\end{enumerate}
\end{frame}
...
\item So, I think it is time to have students install a professional setup: Python, Claude Code, and VS Code. 
...
Ask Claude how to do it (just copy text files to the right folders).  Only has to be done once.
