...
\begin{frame}{Persistent Principles}
\begin{enumerate}
...
\begin{frame}{What Tools to Use Today}
\begin{itemize}
...
\item But, Anthropic's MCP servers and now Claude Skills (10/16/2025) have changed the game.
