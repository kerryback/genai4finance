...
If we have already shown app creation to students, then adding the upload feature is not a big enough step to make for an interesting class session.  But, we could something else new as well.  My suggestion is to have the app generate an interactive dashboard.  
