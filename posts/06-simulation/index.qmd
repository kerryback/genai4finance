...
Both simulation and optimization can be done in spreadsheets but are better done elsewhere.  I illustrate the AI + coding approach by simulating retirement plans and doing mean-variance optimization.
