...
While playing with this, I decided to create a Streamlit app (as discussed [here](https://finance-with-ai.org/posts/05-apps/)) that encapsulates the process. With Julius' help, I created [edgar.finance-with-ai.org](https://edgar.finance-with-ai.org) that follows the steps described above to get the json file for a user-supplied ticker.  It reads the json file into a pandas dataframe, separates the 10-Q's from the 10-K's and provides download links for Excel files containing the data.  That makes it easy for students to work with the data outside of Julius and python.
