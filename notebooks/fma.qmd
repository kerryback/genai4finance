...
My belief is that many of the things we now do with spreadsheets - and other analyses that are now generally infeasible for students - will be done in the future by chatting with AI.  Coding plays a role, because AI models  are not reliable for doing mathematical calculations, but the code they write can be executed reliably by a python engine.

The two platforms that are currently best suited for this purpose are [Julius.ai](https://julius.ai/) and [Google Colab](https://colab.research.google.com/).  Julius integrates generative AI with a user-friendly and user-configurable python environment.  Julius sends the student's prompts to the selected AI model.  The AI models generate code and chat with the student.  The Julius servers execute the code.  The chat is very informative, telling the student what the plan is before the code is generated and then interpreting and explaining the results afterwards.  

Gemini 2.5 was incorporated into Google Colab midway through our course this spring.  In the future, I will start with Colab.  It is a free Jupyter Lab environment that now offers very good AI coding assistance.  I will start with Colab, because I will start the course with basic python instruction, and Colab is a platform where students can either type code themselves or ask the AI to generate it, providing a better environment for learning the basics of python.
...
- Loved this class! such an interesting subject matter and informed instructor. Looked forward to future classes!
