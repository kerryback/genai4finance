...
\begin{itemize}
  \item At present, we need courses on AI, because it has not been integrated into all courses.

\item Once it is integrated into the curriculum, we will not need stand-alone courses.
...
\item In the process, I'll talk about using AI to streamline course preparation.  I'll come back to enhancing learning.
\end{itemize}\end{frame}
